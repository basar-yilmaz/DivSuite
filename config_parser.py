...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Diversification Experiment Configuration")
    ...
    parser.add_argument("--diversifier", type=str, choices=list(DIVERSIFIER_MAP.keys()), 
...
def get_config() -> Dict[str, Any]:
    ...
    final_config['experiment']['diversifier'] = DIVERSIFIER_MAP[final_config['experiment']['diversifier']]
